...
@Configuration
@Profile("prod")
public class ApplicationProdRunner implements ApplicationRunner {
    ...
    /**
     * Persist users and meals for production environment
     * @param args: Input parameters
     * @throws Exception: Throw Exception on unexpected errors
     */
    @Override
    @Transactional
    public void run(ApplicationArguments args) throws Exception {
        ...
        if( this.mealService.getMeals().isEmpty() ) {
            // Persist Meals
            final File file = new File(Constants.DEFAULT_MEAL_IMAGE);
